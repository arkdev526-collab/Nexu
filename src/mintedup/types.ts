...
export type ListingStatus = "draft" | "submitted" | "changes" | "rejected" | "approved" | "active" | "reserved" | "sold" | "ended" | "removed";
...
/** Payment truth is separate from the legacy fulfilment status. */
